...
const std::string gTokenTypeNames[] = {
	...
	"INSERTION", "ASSIGNMENT", "PLUS", "PLUSEQUAL", "MINUS", "MINUSEQUAL", "TIMES",
...
enum TokenType {// Reserved Words
	...
	// Other Operators:
	INSERTION_TOKEN, ASSIGNMENT_TOKEN, PLUS_TOKEN, PLUSEQUAL_TOKEN, MINUS_TOKEN, MINUSEQUAL_TOKEN, TIMES_TOKEN, 
